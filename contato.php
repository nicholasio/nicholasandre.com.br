            ...
            <div class="headercontent">
                <div class="section-container">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <p>
                                Gostou do meu trabalho e está precisando de uma consultoria? Entre em contato!
                                Atualmente ofereço os seguintes serviços:
                            </p>                              
                            <ul>
                                <li>Desenvolvilmento Front-End (HTML5/CSS3/JavaScript)</li>
                                <li>Criação de temas com Wordpress</li>
                                <li>Criação de plugins para Wordpress</li>
                                <li>Treinamentos em Wordpress</li>
                            </ul>
                        </div>
                        <div class="col-md-4">
